...
ITEMS = [
    ...
    ("Water system", "Calorifier 10 L, empty (Elgena Nautic)", 5.0, at("calorifier"), "reimo.com"),
...
LOAD = [
    ...
    ("Water", "Calorifier full + WC flush water", 25.0, 900, "10 + 15 L"),
...
def report():
    ...
    build = lambda r: sum(v[0] for g, v in r["groups"].items() if g not in ("People", "Water", "Gear"))
    load = lambda r: sum(v[0] for g, v in r["groups"].items() if g in ("People", "Water", "Gear"))
